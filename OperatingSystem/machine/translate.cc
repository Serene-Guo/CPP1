...
Machine::ReadMem(int addr, int size, int *value)
{
 ...
 printf("\n未发生异常，地址转换：vAddr%d\tpAddr%d--translate.cc 文件\n ",addr,physicalAddress);
    switch (size) {
      case 1:
...
// from the virtual address
  //  vpn = (unsigned) virtAddr / PageSize;    不对！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！
 //   offset = (unsigned) virtAddr % PageSize;

 currentThread->space->Translate(virtAddr, &vpn, &offset);     //这样的到的才是 正确的 虚拟页号 和 页内 偏移地址
    ...
    pageFrame = entry->physicalPage;  //  得到 物理 祯
