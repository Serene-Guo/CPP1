...
#include "../partitioning/GREEDY/BAPGREEDYPartitioner.h"
#include "../partitioning/SA/BAPSAPartitioner.h"

/********************************
#include "your partitioner path"
// 其实 只有一个 h文件 应该也够了  因为BAPTVPartitioner没变。。。
*/
